...
**Примечание**: в этом дипломном задании используется система мониторинга Prometheus. Вместо Prometheus вы можете использовать Zabbix. Дипломное задание с использованием Zabbix находится по [ссылке]().
